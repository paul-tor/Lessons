...
if year_is_true && month_is_true && date_is_true
  ...
  puts "Ошибка ввода: проверьте введённые значения. Год - положительное число; месяц - число от 1 до 12;" \
       "дата - от 1 до 31 и количество дней соответсвует месяцу и високосности года"
end
